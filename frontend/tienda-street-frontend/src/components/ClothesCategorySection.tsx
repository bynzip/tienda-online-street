...
export function ClothesCategorySection() {
    ...
    const linkRopaHombre = idHombre ? `/productos?genero=${idHombre}` : '/productos?search=hombre';
    const linkRopaMujer = idMujer ? `/productos?genero=${idMujer}` : '/productos?search=mujer';
    ...
    return (
      <section className="flex flex-col md:flex-row p-4 md:gap-6 md:p-8 max-w-7xl mx-auto lg:px-10">
          <Link to={linkRopaHombre} className="group relative flex-1 h-[300px] md:h-[450px] flex flex-col justify-end items-start p-6 md:p-10 text-white overflow-hidden no-underline">
              <img loading="lazy" decoding="async" src="/imagenes/ropa.png" alt="Ropa Hombre" className="absolute inset-0 w-full h-full object-cover transition-transform duration-300 ease-out group-hover:scale-110" />
          ...
          <Link to={linkRopaMujer} className="group relative flex-1 h-[300px] md:h-[450px] flex flex-col justify-end items-start p-6 md:p-10 text-white overflow-hidden no-underline">
              <img loading="lazy" decoding="async" src="/imagenes/Gemini_Generated_Image_vbzj6tvbzj6tvbzj.png" alt="Ropa Mujer" className="absolute inset-0 w-full h-full object-cover transition-transform duration-300 ease-out group-hover:scale-110" />
           ...
           <Link to={linkAccesorios} className="group relative flex-1 h-[300px] md:h-[450px] flex flex-col justify-end items-start p-6 md:p-10 text-white overflow-hidden no-underline">
              <img loading="lazy" decoding="async" src="/imagenes/accesorios.png" alt="Accesorios" className="absolute inset-0 w-full h-full object-cover transition-transform duration-300 ease-out group-hover:scale-110" />
              <div className="absolute inset-0 bg-linear-gradient from-black/80 via-black/20 to-transparent z-10 transition-all duration-300 group-hover:from-black/90"></div>
              <div className="relative z-20 w-full">
