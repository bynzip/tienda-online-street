...
export function ClothesCategorySection() {
    return (
      <section className="flex flex-col md:flex-row p-4 md:gap-6 md:p-8 max-w-7xl mx-auto lg:px-10">
          <Link to="/categoria/ropa-hombre" className="group relative flex-1 h-[300px] md:h-[450px] flex flex-col justify-end items-start p-6 md:p-10 text-white overflow-hidden no-underline">
          ...
          <Link to="/categoria/ropa-mujer" className="group relative flex-1 h-[300px] md:h-[450px] flex flex-col justify-end items-start p-6 md:p-10 text-white overflow-hidden no-underline">
           ...
           <Link to="/categoria/accesorios" className="group relative flex-1 md:flex-[0.5] h-[300px] md:h-[450px] flex flex-col justify-end items-start p-6 md:p-10 text-white overflow-hidden no-underline">
              <img src="/imagenes/accesorios.png" alt="Accesorios" className="absolute inset-0 w-full h-full object-cover transition-transform duration-700 ease-out group-hover:scale-110" />
              <div className="absolute inset-0 bg-linear-to-t from-black/80 via-black/20 to-transparent z-1 transition-all duration-300 group-hover:from-black/90"></div>
              <div className="relative z-2 w-full">
